...
using translations and **proper rotations of one physical handedness**.
...
global grid, needs mathematical review. Allowing a separately manufactured
mirror image has not been analyzed. No novelty or priority claim is made.

![The recut chair and its eight-chair group](artifacts/recut-chair.png)
...
opposing the base normals forces the relative rotation to be a proper
...
3. Check the convention about reflected copies. The present construction
   and certificates use proper rotations of one physical handedness.
...
both display modes and the separation control passed without page errors.
