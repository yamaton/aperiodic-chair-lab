...
def main():
    ...
    parser.add_argument('--source',type=Path,default=ROOT/'artifacts'/'forced_outer_layer_4.json')
    parser.add_argument('--output',type=Path,default=ROOT/'artifacts'/'expanded_arc_audit.json')
