"""Q014 continuation: one exact synchronous forced-neighbor expansion.
...
def main():
    ...
    parser.add_argument('--input',type=Path,default=ROOT/'artifacts'/'forced_outer_layer.json')
    parser.add_argument('--output',type=Path,default=ROOT/'artifacts'/'forced_outer_layer_2.json')
