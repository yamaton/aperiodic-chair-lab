"""Q032: star-domain arcs with explicit atlas/rule and pose namespace.
...
def main():
    ...
    parser.add_argument('--output',type=Path,default=ROOT/'artifacts'/'coarse_expanded_arcs_1.json')
